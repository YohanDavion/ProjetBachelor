    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="list-inline dashboard-menu text-center">
          <li><a class="active" href="/profile">Information Utilisateur</a></li>
              ...
              <div class="media-body">
                <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                  <ul class="user-profile-list">
                    ...
                    <li><span>Prénom:</span><input type="text" name="firstname" value="<?= htmlspecialchars(explode(' ', $_SESSION['name'])[1]) ?>"></li>
                    <li><span>Nom:</span><input type="text" name="lastname" value="<?= htmlspecialchars(explode(' ', $_SESSION['name'])[0]) ?>"></li>
                    <li><span>Adresse:</span><input type="text" name="address" value="<?= htmlspecialchars($_SESSION['address']) ?>"></li>
                    <li><span>Téléphone:</span><input type="tel" name="phone" value="<?= htmlspecialchars($_SESSION['phone']) ?>"></li>
